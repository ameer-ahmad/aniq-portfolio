    ...
    >
        ...
        <div className="text-image-container">
            ...
            <div className='image-container'>
                <img src="/point-cross.png" alt="Point Cross Beach RV Park" />
            </div>
        </div>
        ...
        <div className="text-image-container">
            ...
            <div className='image-container'>
                <img src="/web-design2.png" alt="Web Design" />  
            </div>
        </div>

        <div className='rv-image-container'>
            <img src="/mockup-rv.png" alt="RV Mockup" /> 
            <img src="/conclusion2.png" alt="conclusion" /> 
            <img src="/final.png" alt="Final Mockups" className='final-mockups' /> 
            <img src="/final-rv.png" alt="Point Cross Final" />  
            <div className='shirt-container'>
                <div>
                    <img src="/tshirt1.png" alt="Point Cross T Shirt 1" className='rv-shirt'/>  
                </div>
                <div>
                    <img src="/tshirt2.png" alt="Point Cross T Shirt 2" className='rv-shirt'/>
                </div>
            </div> 
            <img src="/rv-mug.png" alt="Point Cross Mug" />   
        </div>
